        ...
        <View style={{ paddingHorizontal: 15, paddingTop: 20, backgroundColor: defaultStyling.light }}>
...

            {
                results ? (
                    ...
                    <View style={{ backgroundColor: defaultStyling.light, justifyContent: 'center', alignItems: 'center', width: '100%', height: '100%' }}>
                        <Text style={{ color: defaultStyling.dark, fontSize: 20, fontWeight: '500' }}>Data Not Found</Text>
                    </View>
                )
            }
